              ...
              <div class="pager" v-if="totalPages > 0">
                <ul class="pagination justify-content-center">
                  <li @click="updatePage(prev)" class="page-item">
                    <a v-if="showPrevLink"class="page-link fa fa-arrow-left" href="javascript:void(0)" aria-label="Previous"></a>
                  </li>
                  ...
                  <li @click="updatePage(next)" class="page-item">
                    <a v-if="showNextLink"class="page-link fa fa-arrow-right" href="javascript:void(0)" aria-label="Next"></a>
                  </li>
                </ul>
              </div>`,

              props:
                ['current_page', 'row_count_page','total_records','page_range'], 
              computed:
                {
                  prev(){return this.current_page - 1},
                  next(){return this.current_page + 1},
                  rangeStart(){
                  ...
                  firstPage(){return this.rangeStart !==0 },
                  lastPage(){return this.rangeEnd < this.totalPages},
                  showPrevLink() {return this.current_page == 0 ? false : true;},
                  showNextLink() {return this.current_page == (this.totalPages - 1) ? false : true;}
                },
              methods: 
              {
